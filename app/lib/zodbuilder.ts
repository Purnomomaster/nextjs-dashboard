...
export function buildZodSchema(inputFields: InputField[]): { [key: string]: ZodTypeAny } {
    ...
    inputFields.forEach((field) => {
        ...
        if (field.required === 'Y') {
            fieldSchema = (fieldSchema as z.ZodString).min(1, { message: `${field.kolom} is required` });
        }
