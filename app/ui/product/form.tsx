...
import { createProduct, updateProduct } from '@/app/model/product/action';
import Link from 'next/link';
import { Button } from '@/app/ui/button';
import { useActionState } from 'react';
// import { generateState } from '@/app/lib/statebuilder';
import inputproduct from './inputproduct';
// const initialState = generateState(inputproduct);
  ...
  const action =
    mode === 'create'
      ...
      : product?.id
        ...
        : () => Promise.reject('Product ID is required for update');
